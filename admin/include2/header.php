...
//        
        ...
        {
            $dem_mtch=1;
            foreach ($current_url_tach as $current_url_tach2)
            {
                if($dem_mtch == $tm)
                {
                    if($current_url_tach2 != "index.php")
                    {
            ...
            <div class="box-footer">
              ...
              <!-- Menu Footer-->
               ...
               <li class="user-footer">
                <div class="pull-left">
                    <a href="../my_account.php" class="btn btn-default btn-flat">Thông Tin</a>
                </div>
                   <div class="pull-left">
                       <a href="../doi_pass_tv.php" class="btn btn-default btn-flat">Đổi Pass</a>
                </div>
